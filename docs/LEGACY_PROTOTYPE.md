# TrAIner — Legacy Interactive Prototype (v1)

> [!WARNING]
> This file describes the legacy interactive prototype built on pure HTML + Babel in-browser transpilation. 
> The active production system (V2) uses Vite, TypeScript, and Supabase. See the main `README.md` and `trainer_system_design.md` for current architectural details.
...
## Conventions / gotchas (Prototype Phase)
...
- **Cycle phases:** se mudar `computeCyclePhases`, manter as 4 fases presentes (o código atual usa Math.max).
