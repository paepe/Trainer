...
export default function App() {
  ...
  const [prefs, setPrefs] = React.useState<AppPreferences>({
    ...
    darkMode: true, keepExerciseNamesInEnglish: true,
  ...
  React.useEffect(() => {
    ...
    function setPrefsFromApi(data: Record<string, unknown> | null | undefined, cyDefault: boolean) {
      ...
      setPrefs({
        ...
        keepExerciseNamesInEnglish: (data.keep_exercise_names_in_english as boolean | undefined) ?? true,
  ...
  const handleSetPrefs = (newPrefs: AppPreferences) => {
    ...
    savePreferences({
      ...
      keep_exercise_names_in_english: newPrefs.keepExerciseNamesInEnglish,
  ...
  const screenContent = (() => {
    ...
    switch (screen) {
      ...
      case 'workout':            return <StartWorkoutScreen      {...common} source={screenPayload?.source as string | undefined} timeoutNotificationId={screenPayload?.timeoutNotificationId as string | undefined}/>;
